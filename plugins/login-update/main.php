...
//SE HA INICIADO SESION:
   ...
   */
   echo "Bienvenido <b>$session->username</b>. <br><br>"
       ...
       ."[<a href=\"useredit.php\">Cambiar contrase&ntilde;a</a>] &nbsp;&nbsp;";
   /*
   if($session->isAdmin()){
      echo "[<a href=\"admin/admin.php\">Admin Center</a>] &nbsp;&nbsp;"; //LUEGO
   }/**/

   echo "[<a href=\"process.php\">Cerrar sesi&oacute;n</a>]"; // SI
}
else{
//SINO SE HA INICIADO SESION:
?>
<!----
